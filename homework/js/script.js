...
var greeting ="Hello" + "I'm" +  name  + "and"  +"I'm" + age + "years old" + "and" +"I live" + "at"+ address;
...
*/
var greeting2 = console.log(`Hello I'm ${name} and I'm ${age} years old and I live at ${address}`);
...
/*
	...
	belongs in a variable. 	Well first I need to to pick the ten numbers and put them in a array
    declared that array in a variable. declared another the biggest variable. Use the name of the array.length and compare that with the biggest number
    a four loop.
